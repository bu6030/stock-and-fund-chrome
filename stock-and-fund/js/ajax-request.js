...
function ajaxGetStockFromEastMoney(code, stocks) {
    $.ajax({
        url: Env.GET_STOCK_FROM_EAST_MONEY_URL
          + "?fltt=2&fields=f12,f13,f19,f15,f16,f14,f139,f148,f124,f2,f25,f4,f1,f125,f18,f3,f152,f5,f30,f31,f32,f6,f8,f7,f10,f22,f9,f112,f114,f115,f100,f88,f145,f153&secids="
          + code,
        timeout: 5000, // 设置超时时间为5000毫秒（5秒）
        type: "get",
        data: {},
...
function ajaxGetStockTimeImageMinuteMiniPromise(code) {
    return new Promise((resolve, reject) => {
        ...
        $.ajax({
            ...
            contentType: 'application/x-www-form-urlencoded',
            success: function (data) {
                setStockMinitesImageMini(data, oldCode);
                resolve();
            },
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                console.log(XMLHttpRequest.status);
...
function ajaxGetFundTimeImageMinuteMiniPromise(code) {
    return new Promise((resolve, reject) => {
        $.ajax({
            ...
            contentType: 'application/x-www-form-urlencoded',
            success: function (data) {
                setFundMinitesImageMini(data, code);
                resolve();
            },
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                console.log(XMLHttpRequest.status);
